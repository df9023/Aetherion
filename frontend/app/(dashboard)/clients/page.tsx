...
import { Plus, Search, Building2, Shield } from "lucide-react"
    ...
    <div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        {!isLoading && filtered.map((c) => (
          <div
            key={c.id}
            className="rounded-xl border border-slate-200/60 bg-white p-5 shadow-sm transition-all duration-200 hover:border-slate-300 hover:shadow-md"
          >
