...
export function Sidebar() {
  ...
  const navItems = [
    { href: "/cases", icon: Briefcase, label: "Cases", badge: cases?.filter((c) => c.status !== "archived").length },
    { href: "/clients", icon: Users, label: "Clients", badge: clients?.length },
    { href: "/knowledge", icon: BookOpen, label: "Knowledge Base", badge: knowledge?.length },
  ]
